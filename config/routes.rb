ActionController::Routing::Routes.draw do |map|
	...
	#map.connect 'legislator/:fecid',:controller=>'legislator',:action => 'show',:method => 'get'
	
	map.connect '', :controller=>'home', :action => 'index'
	#map.connect '/home', :controller=>'home', :action => 'index'
  map.connect '/candidate/expenditures_by_district', :controller => 'candidate',:action => 'expenditures_by_district', :method => 'get'

	map.resources :district, :except => ['new','update']
